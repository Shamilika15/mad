...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val addETTitle1= addTaskDialog.findViewById<TextInputEditText>(R.id.edTaskTitle1)
        val addETTitleL1 = addTaskDialog.findViewById<TextInputLayout>(R.id.edTaskTitleL1)

        addETTitle1.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
            override fun afterTextChanged(s: Editable) {
                validateEditText(addETTitle1, addETTitleL1)
            }
        })
        ...
        mainBinding.addTaskFABtn.setOnClickListener {
            ...
            clearEditText(addETTitle1, addETTitleL1)
        ...
        saveTaskBtn.setOnClickListener {
            if (validateEditText(addETTitle, addETTitleL)
                && validateEditText(addETDesc, addETDescL) && validateEditText(addETTitle1, addETTitleL1)
            ) {
                ...
                val newTask = Task(
                    ...
                    addETTitle1.text.toString().trim(),
                    currentDate
                )
                hideKeyBoard(it)
        ...
        val updateETTitle1 = updateTaskDialog.findViewById<TextInputEditText>(R.id.edTaskTitle1)
        val updateETTitleL1 = updateTaskDialog.findViewById<TextInputLayout>(R.id.edTaskTitleL1)

        updateETTitle1.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
            override fun afterTextChanged(s: Editable) {
                validateEditText(updateETTitle1 , updateETTitleL1)
            }
        })
...
//                .deleteTask(task)
                ...
                updateETTitle1.setText(task.priority)


                updateTaskBtn.setOnClickListener {
                    if (validateEditText(updateETTitle, updateETTitleL)
                        && validateEditText(updateETDesc, updateETDescL) &&  validateEditText(updateETTitle1 , updateETTitleL1)
                    ) {
                        val currentDate = Date().toString()
                        val updateTask = Task(
                            task.id,
                            ...
                            updateETTitle1.text.toString().trim(),
                            currentDate
